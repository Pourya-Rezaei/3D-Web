...
const jobs: Job[] = [
  {
    ...
    size: '1024x1024',
    prompt:
      'Ultra luxury wristwatch macro photography, gold and black skeleton mechanical watch floating, dramatic studio lighting, deep black background, gold particles, cinematic, ultra detailed, 8k, hyper realistic, premium advertisement',
  },
  {
    name: 'watch-1.png',
    size: '1024x1024',
    prompt:
      'Luxury automatic wristwatch with rose gold case, black sunburst dial, brown leather strap, isolated on pure black background, professional studio product photography, soft reflections, ultra detailed, premium advertisement style',
  },
  {
    name: 'watch-2.png',
    size: '1024x1024',
    prompt:
      'Luxury diver watch with stainless steel case, deep blue dial, blue ceramic bezel, metal bracelet, isolated on pure black background, professional studio product photography, water droplets, ultra detailed, premium advertisement',
  },
  {
    name: 'watch-3.png',
    size: '1024x1024',
